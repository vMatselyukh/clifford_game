...
var Runner = module.exports = function() {
    ...
    var SERVER_URL  = 'https://dojorena.io/codenjoy-contest/board/player/dojorena1066?code=7871173414232466060';
    ...
    var processBoard = function(boardString) {
        ...
        let newBoard = Solver.get(board);

        newBoard = newBoard || board;

        var answer = newBoard.toString();
